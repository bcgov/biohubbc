...
it('Login', function () {
  ...
  while (i < 1) {
    ...
    // cy.get('.MuiContainer-root > .MuiBox-root').click();
    ...
    cy.get('#coordinator_agency-option-7').click();
    ...
    cy.get('[data-testid=stepper_next] > .MuiButton-label').click();
    ...
    cy.get('.jss30 > .MuiContainer-root').click({ force: true });
    cy.get('#ancillary_species').click({ force: true });
    cy.get('#ancillary_species-option-5').click();
    cy.get('.jss42').click({ force: true });
    cy.get('[data-testid=stepper_next] > .MuiButton-label').click();
    cy.get('.jss42').click();
    cy.get('[data-testid=stepper_submit] > .MuiButton-label').click();
    cy.get('#menu_projects').click();
    /* ==== End Cypress Studio ==== */
    i++;
  }
