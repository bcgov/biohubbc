...
describe('GetPartnershipsData', () => {
  ...
  describe('indigenous_partnerships values provided', () => {
    ...
    const indigenous_partnerships = ['partner 1', 'partner 2'];
    ...
    it('sets indigenous_partnerships', function () {
      expect(data.indigenous_partnerships).to.eql(indigenous_partnerships);
    });
  ...
  describe('stakeholder_partnerships values provided', () => {
    ...
    const stakeholder_partnerships = ['partner 1', 'partner 2'];
    ...
    it('sets stakeholder_partnerships', function () {
      expect(data.stakeholder_partnerships).to.eql(stakeholder_partnerships);
    });
  });
  ...
  describe('All values provided', () => {
    ...
    const indigenous_partnerships = ['partner 1', 'partner 2'];
    const stakeholder_partnerships = ['partner 3', 'partner 4'];
