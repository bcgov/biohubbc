...
/**
 * Project endpoint put body openapi schema.
 *
 * TODO incomplete/out of date
 */
 ...
 * TODO incomplete/out of date
 */
export const getProjectForViewRequestBody = {
  title: 'Project Post Object',
  type: 'object',
  properties: {
    coordinator: {
...
/**
 * Basic response body a projects ID.
 */
export const projectIdResponseBody = {
...
/**
 * Response body for GET project data, for view-only purposes
 *
 * // TODO incomplete/out of date
 */
export const projectViewGetResponseBody = {
  title: 'Project View Response Object',
  type: 'object',
  required: ['id'],
  properties: {
    id: {
