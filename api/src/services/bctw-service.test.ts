...
import { DEPLOY_DEVICE_ENDPOINT, GET_DEPLOYMENTS_ENDPOINT, UPDATE_DEPLOYMENT_ENDPOINT, GET_COLLAR_VENDORS_ENDPOINT, HEALTH_ENDPOINT, GET_CODE_ENDPOINT, GET_DEPLOYMENTS_BY_CRITTER_ENDPOINT, GET_DEVICE_DETAILS, GET_DEPLOYMENTS_BY_DEVICE_ENDPOINT, GET_KEYX_STATUS_ENDPOINT, UPSERT_DEVICE_ENDPOINT, GET_TELEMETRY_POINTS_ENDPOINT, GET_TELEMETRY_TRACKS_ENDPOINT, DELETE_DEPLOYMENT_ENDPOINT, MANUAL_TELEMETRY, VENDOR_TELEMETRY, MANUAL_AND_VENDOR_TELEMETRY } from '../constants/bctw-routes';
import { IDeployDevice, IDeploymentUpdate } from '../models/bctw';
import { BctwService } from './bctw-service/bctw-service';
