...
import {
  findMatchingPeriodsWithObservedDateTime,
...
} from './habitat-feature-sampling-row-validator';
...
describe('Worksheet sampling util functions', () => {
  ...
  describe('getHabitatFeatureSamplingInformationRowValidator', () => {
    it('should throw an error when sample period id does not exist in the sample periods', () => {
      ...
      const validator = getHabitatFeatureSamplingInformationRowValidator(rowValidatorParams);
    ...
    it('should return no errors when no sampling information and habitat feature date provided with lat/lon', () => {
      const getCellValueStub = sinon.stub();
    ...
    it('should return an error when no sampling information and no habitat feature date provided', () => {
      const getCellValueStub = sinon.stub();
    ...
    describe('A: habitat feature date and time included', () => {
      ...
      it('A: should return errors when unable to uniquely match period with date and time', () => {
        ...
        expect(result.length).to.equal(2);
        expect(result[0].error).to.contain('habitat feature date and time');
      });
    });

    describe('B: habitat feature date and time not included but period contains time information', () => {
  ...
  describe('findMatchingPeriodsWithObservedDateTime', () => {
    it('matches no sampling period records when no sampling period records provided', () => {
      const observedDate = '2021-01-01';
      const observedTime = '11:00:00';
      const samplingPeriods: SurveySamplePeriodDetails[] = [];

      const result = findMatchingPeriodsWithObservedDateTime(observedDate, observedTime, samplingPeriods);
    ...
    it('matches the end date/time of two period records', () => {
      const observedDate = '2021-01-02';
      const observedTime = '12:00:00';
      const samplingPeriods: SurveySamplePeriodDetails[] = [
        {
          survey_sample_period_id: 11,
          survey_id: 21,
    ...
    it('matches the date range of two period records on date and time', () => {
      const observedDate = '2021-01-05';
      const observedTime = '18:00:00';
      const samplingPeriods: SurveySamplePeriodDetails[] = [
        {
          survey_sample_period_id: 11,
          survey_id: 21,
    ...
    it('does not matche the date range of any period records on date and time', () => {
      const observedDate = '2021-01-20';
      const observedTime = '05:00:00';
      const samplingPeriods: SurveySamplePeriodDetails[] = [
        {
          survey_sample_period_id: 11,
          survey_id: 21,
