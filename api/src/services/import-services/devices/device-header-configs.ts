...
import { DeviceCSVStaticHeader } from './import-device-service';
 ...
 */
export const getDeviceVendorCellValidator = (vendors: Set<string>): CSVCellValidator => {
  ...
  return (params) => {
    ...
    return [
      {
        error: `Device vendor not supported`,
        solution: `Use a valid device vendor`,
 ...
 * @param {CSVConfigUtils<DeviceCSVStaticHeader>} utils The CSV config utils
 * @returns {*} {CSVCellValidator} The validate cell callback
 */
