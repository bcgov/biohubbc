...
describe('MarkdownService', () => {
  ...
  describe('updateScore', () => {
    it('should update the score and return the new score', async () => {
      ...
      const response = await markdownService.updateScore(markdownId, systemUserId, delta);

      expect(updateScoreStub).to.be.calledOnceWith(markdownId, systemUserId, delta);
