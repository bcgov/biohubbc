...
describe('SurveyService', () => {
  ...
  describe('getCrittersInSurvey', () => {
    it('returns the first row on success', async () => {
      ...
      const repoStub = sinon.stub(SurveyRepository.prototype, 'getCrittersInSurvey').resolves(data);
  ...
  describe('addCritterToSurvey', () => {
    it('returns the first row on success', async () => {
      ...
      const repoStub = sinon.stub(SurveyRepository.prototype, 'addCritterToSurvey').resolves(1);
  ...
  describe('removeCritterFromSurvey', () => {
    it('returns the first row on success', async () => {
      ...
      const repoStub = sinon.stub(SurveyRepository.prototype, 'removeCritterFromSurvey').resolves(1);
  ...
  describe('addDeployment', () => {
    it('returns the first row on success', async () => {
      ...
      const repoStub = sinon.stub(SurveyRepository.prototype, 'addDeployment').resolves(1);
