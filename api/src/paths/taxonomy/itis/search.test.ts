...
describe('search', () => {
  ...
  describe('searchSpecies', () => {
    ...
    it('returns an empty array if no species are found', async () => {
      ...
      const getSpeciesFromIdsStub = sinon.stub(TaxonomyService.prototype, 'itisSearch').resolves([]);
    ...
    it('returns an array of species', async () => {
      ...
      const getSpeciesFromIdsStub = sinon.stub(TaxonomyService.prototype, 'itisSearch').resolves([mock1, mock2]);
    ...
    it('catches error, and re-throws error', async () => {
      ...
      sinon.stub(TaxonomyService.prototype, 'itisSearch').rejects(new Error('a test error'));
