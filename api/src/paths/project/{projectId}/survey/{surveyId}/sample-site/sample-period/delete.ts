...
const defaultLog = getLogger('paths/project/{projectId}/survey/{surveyId}/sample-site/sample-period/delete');
...
export function deleteSamplePeriods(): RequestHandler {
  return async (req, res) => {
    ...
    try {
      ...
      await samplePeriodService.deleteSamplePeriodRecords(surveyId, surveySamplePeriodIds);
