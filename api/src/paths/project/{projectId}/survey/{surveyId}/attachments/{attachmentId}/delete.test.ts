...
describe('deleteAttachment', () => {
  ...
  it('should return the rowCount response on success when attachment type is not Report', async () => {
    const mockQuery = sinon.stub();
  ...
  it('should return the rowCount response on success when attachment type is Report', async () => {
    const mockQuery = sinon.stub();
