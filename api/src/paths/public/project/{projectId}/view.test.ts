...
describe('project/{projectId}/view', () => {
  ...
  describe('viewPublicProject', () => {
    ...
    it('fetches a project', async () => {
      ...
      sinon.stub(ProjectService.prototype, 'getPublicProjectById').resolves(viewProjectResult as any);
    ...
    it('catches and re-throws error', async () => {
      ...
      sinon.stub(ProjectService.prototype, 'getPublicProjectById').rejects(new Error('a test error'));
