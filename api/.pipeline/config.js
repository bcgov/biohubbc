...
const phases = {
  ...
  dev: {
    ...
    name: `${name}`,
    dbServiceName: `${dbName}-postgresql-dev-${deployChangeId}`,
    dbSecretName: `${dbName}-postgresql-dev-${deployChangeId}`,
    phase: 'dev',
  ...
  test: {
    ...
    name: `${name}`,
    dbServiceName: `${dbName}-postgresql-test`,
    dbSecretName: `${dbName}-postgresql-test`,
    phase: 'test',
    changeId: deployChangeId,
    suffix: `-test`,
    instance: `${name}-test`,
  ...
  'test-spi': {
    namespace: 'af2668-test',
    name: `${name}-spi`,
    dbName: 'spi-migrate-primary.af2668-test.svc',
  ...
  prod: {
    ...
    name: `${name}`,
    dbServiceName: `${dbName}-postgresql-prod`,
    dbSecretName: `${dbName}-postgresql-prod`,
    phase: 'prod',
    changeId: deployChangeId,
    suffix: `-prod`,
    instance: `${name}-prod`,
