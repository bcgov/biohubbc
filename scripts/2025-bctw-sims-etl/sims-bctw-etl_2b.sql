--------------------------------------------------------------------------------------------------------------
-- Populate mismatched_sims_deployments table
--------------------------------------------------------------------------------------------------------------

-- Insert all sims deployment records that do not have a matching bctw deployment record
...
where
    biohub.deployment_old.bctw_deployment_id not in (
        select
            deployment_id
        from
