...
drop table if exists bctw.matched_collar_deployment cascade;
...
CREATE TABLE if not exists bctw.matched_collar_deployment (
    matched_collar_deployment_id               INTEGER          GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
    --
