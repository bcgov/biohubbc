...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    COMMENT ON TABLE  environment_quantitative                                IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_quantitative.environment_quantitative_id    IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_quantitative.name                           IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_quantitative.description                    IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_quantitative.min                            IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_quantitative.max                            IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    ...
    COMMENT ON TABLE  environment_qualitative_option                                      IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_qualitative_option.environment_qualitative_option_id    IS 'Primary key to the table.';
    COMMENT ON COLUMN environment_qualitative_option.name                                 IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_qualitative_option.description                          IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    ...
    COMMENT ON TABLE  environment_qualitative                               IS 'This table is intended to track quantitative environments applied to a particular observation_subcount.';
    COMMENT ON COLUMN environment_qualitative.environment_qualitative_id    IS 'Primary key to the table.';
    COMMENT ON COLUMN environment_qualitative.observation_subcount_id       IS 'Foreign key to the subcount table.';
    COMMENT ON COLUMN environment_qualitative.value                         IS 'Quantitative data value.';
    ...
    COMMENT ON COLUMN observation_subcount_quantitative_environment.observation_subcount_quantitative_environment_id    IS 'Primary key to the table.';
    COMMENT ON COLUMN observation_subcount_quantitative_environment.observation_subcount_id                             IS 'Foreign key to the subcount table.';
    ...
    COMMENT ON COLUMN observation_subcount_qualitative_environment.observation_subcount_id                            IS 'String representation of the data provided.';
    COMMENT ON COLUMN observation_subcount_qualitative_environment.environment_qualitative_option_id                  IS 'The id of a qualitative environment option.';
