...
export async function seed(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    CREATE TRIGGER tr_before_device_generate_device_key BEFORE INSERT OR UPDATE ON biohub.device FOR EACH ROW EXECUTE PROCEDURE do_sample_period_dates_overlap();
  `);
}
