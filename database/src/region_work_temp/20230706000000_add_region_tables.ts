...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    ALTER TABLE project_region ADD CONSTRAINT project_region_fk001 FOREIGN KEY (project_id) REFERENCES projects (project_id);
    ALTER TABLE project_region ADD CONSTRAINT project_region_fk002 FOREIGN KEY (region_id) REFERENCES region_lookup (region_id);
    ALTER TABLE survey_region ADD CONSTRAINT survey_region_fk001 FOREIGN KEY (survey_id) REFERENCES surveys (survey_id);
