...
CREATE UNIQUE INDEX a_nuk1 ON activity(name, record_end_date)
;
-- 
-- INDEX: "Ref14877" 
--
...
CREATE UNIQUE INDEX aast_nuk1 ON administrative_activity_status_type(name, record_end_date)
;
-- 
-- INDEX: aat_nuk1 
--

CREATE UNIQUE INDEX aat_nuk1 ON administrative_activity_type(name, record_end_date)
;
-- 
-- INDEX: as_uk1 
--
...
CREATE UNIQUE INDEX cci_nuk1 ON climate_change_initiative(name, record_end_date)
;
-- 
-- INDEX: cci_nuk1_1 
--

CREATE UNIQUE INDEX cci_nuk1_1 ON first_nations(name, record_end_date)
;
-- 
-- INDEX: fs_uk1 
--
...
CREATE UNIQUE INDEX fs_nuk2 ON funding_source(name, record_end_date)
;
-- 
-- INDEX: iac_nuk1 
--

CREATE UNIQUE INDEX iac_nuk1 ON investment_action_category(fs_id, name, record_end_date)
;
-- 
-- INDEX: "Ref7345" 
--
...
CREATE UNIQUE INDEX iucn_nuk1 ON iucn_conservation_action_level_1_classification(name, record_end_date)
;
-- 
-- INDEX: iucn2_nuk1 
--
...
CREATE UNIQUE INDEX iucn3_nuk1 ON iucn_conservation_action_level_3_subclassification(name, iucn2_id, record_end_date)
;
-- 
-- INDEX: "Ref13974" 
--
...
CREATE UNIQUE INDEX mat_nuk1 ON management_action_type(name, record_end_date)
;
-- 
-- INDEX: nsp_uk1 
--
...
CREATE UNIQUE INDEX pr_nuk1 ON project_role(name, record_end_date)
;
-- 
-- INDEX: pt_nuk1 
--

CREATE UNIQUE INDEX pt_nuk1 ON project_type(name, record_end_date)
;
-- 
-- INDEX: pt_nuk1_1 
--

CREATE UNIQUE INDEX pt_nuk1_1 ON proprietor_type(name, record_end_date)
;
-- 
-- INDEX: sp_uk1 
--
...
CREATE UNIQUE INDEX sr_nuk1 ON system_role(name, record_end_date)
;
-- 
-- INDEX: su_nuk1 
--

CREATE UNIQUE INDEX su_nuk1 ON system_user(user_identifier, uis_id, record_end_date)
;
-- 
-- INDEX: "Ref12041" 
--
...
CREATE UNIQUE INDEX uis_nuk1 ON user_identity_source(name, record_end_date)
;
-- 
-- INDEX: "Ref7876" 
--
