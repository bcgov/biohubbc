...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`--sql
    ...
    VALUES
        (1, '## Projects and Surveys\n\nProjects and Surveys let you organize and manage access to data. You can think of Projects and Surveys as folders and subfolders, respectively.\n\n##### Projects\nYou can invite other users to a Project to give them access to information in the Project.\n- All Projects you have created or been invited to will appear in your Projects list.\n- If you need access to an existing Project, your collaborator can invite you.\n\n##### Surveys\nSurveys let you organize ecological data collected in the field.\n- When you return from the field with new data, you can choose to create a new Survey or add to an existing Survey.\n- If you do multiple fieldwork trips with a common goal, such as checking the same hair snares every three months, we recommend adding new data to the existing Survey representing why you are collecting hair.'),
