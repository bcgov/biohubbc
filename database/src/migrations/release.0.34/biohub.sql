...
;
COMMENT ON COLUMN project.publish_timestamp IS '(Deprecated) A timestamp that indicates that the project metadata has been approved for discovery. If the timestamp is not null then project metadata is public. If the timestamp is null the project metadata is not yet public.'
;
...
;
COMMENT ON COLUMN survey.publish_timestamp IS '(Deprecated) A timestamp that indicates that the survey metadata has been approved for discovery. If the timestamp is not null then project metadata is public. If the timestamp is null the survey metadata is not yet public.'
;
