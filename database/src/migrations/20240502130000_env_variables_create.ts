...
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Previous 48 hr Precipitation'),
...
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Rapidly drained',
  'Water is removed from the soil rapidly. Excess water flows downward if underlying material is pervious. Subsurface flow may occur on steep gradients during heavy rainfall. Water source is precipitation. Soils are generally coarse textured.'
),
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Well drained',
  'Water is removed from the soil readily. Excess water flows downward into underlying pervious material or laterally as subsurface flow. The water source is precipitation. Soils are generally intermediate in texture and lack restricting layers.'
),
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Moderately well drained',
  'Water is removed from the soil slowly in relation to supply because of imperviousness or lack of gradient. Precipitation is the dominant water source; precipitation and significant additions by subsurface flow are necessary.'
),
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Imperfectly drained',
  'Water is removed from the soil slowly in relation to supply to keep the soil wet for a significant part of the growing season. If subsurface water or groundwater is the main source, the soil remains wet for a part of the growing season.'
),
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Poorly drained',
  'Water is removed so slowly that the soil remains wet for the time that it is not frozen. Excess water is in the soil for a large part of the time. Subsurface or groundwater flow, in addition to precipitation, are the main water sources.'
),
(
  (SELECT environment_qualitative_id FROM environment_qualitative WHERE name = 'Soil Drainage'),
  'Very poorly drained',
  'Water is removed from the soil so slowly that the water table remains at or near the surface for most of the time the soil is not frozen. Groundwater flow and subsurface flow are the major water sources. Typically associated with wetlands.'
),
(
