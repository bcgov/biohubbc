 ...
 create trigger audit_common_survey_methodology_species_template before insert or update or delete on biohub.common_survey_methodology_species_template for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_common_survey_methodology_species before insert or update or delete on biohub.common_survey_methodology_species for each row execute procedure tr_audit_trigger();
