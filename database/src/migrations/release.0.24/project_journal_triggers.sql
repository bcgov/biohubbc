 ...
 create trigger journal_common_survey_methodology_species_template after insert or update or delete on biohub.common_survey_methodology_species_template for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_common_survey_methodology_species after insert or update or delete on biohub.common_survey_methodology_species for each row execute procedure tr_journal_trigger();
