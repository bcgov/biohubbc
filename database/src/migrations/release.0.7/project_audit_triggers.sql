 ...
 drop trigger if exists audit_project_iucn_action_classificaton on biohub.project_iucn_action_classificaton;
 ...
 create trigger audit_project_iucn_action_classificaton before insert or update or delete on biohub.project_iucn_action_classificaton for each row execute procedure tr_audit_trigger();
