...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
    ...
    CREATE TABLE checklist_item (
        ...
        CONSTRAINT checklist_item_system_user_fk FOREIGN KEY (create_user) REFERENCES "system_user" (system_user_id)
    );

    CREATE INDEX checklist_item_idx ON checklist_item (create_user); -- Index for user-based queries
