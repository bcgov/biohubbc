 ...
 create trigger journal_summary_parameter_method_code after insert or update or delete on biohub.summary_parameter_method_code for each row execute procedure tr_journal_trigger();
