import { basicCodeValidator, basicNumericValidator, DeerItems } from './picklist';

export const deerGroundTransectRecruitCompJSON = {
  name: '',
  description: '',
  files: [
    {
      ...
      columns: [
        ...
        },
        {
          name: 'Vehicle Method',
          description: '',
          validations: basicCodeValidator(DeerItems.vehicleMethod)
        }
      ],
      validations: [
        {
