import { basicCodeValidator, basicNumericValidator, summaryPickList } from './picklist';
      ...
      columns: [
        {
          name: 'Parameter',
          description: '',
          validations: basicCodeValidator(summaryPickList.parameter)
        },
        {
          name: 'Observed',
          description: '',
        ...
        },
        {
          ...
          description: '',
          validations: basicCodeValidator(summaryPickList.sightabilityModel)
        },
        {
          name: 'Stratum',
          description: '',
        ...
        },
        {
          ...
          description: '',
          validations: basicCodeValidator(summaryPickList.bestParameterValueFlag)
        },
        {
