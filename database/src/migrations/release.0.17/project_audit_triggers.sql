 ...
 create trigger audit_survey_occurrence before insert or update or delete on biohub.survey_occurrence for each row execute procedure tr_audit_trigger();
 create trigger audit_survey_publish_history before insert or update or delete on biohub.survey_publish_history for each row execute procedure tr_audit_trigger();
