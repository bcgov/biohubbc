 ...
 create trigger journal_survey_occurrence after insert or update or delete on biohub.survey_occurrence for each row execute procedure tr_journal_trigger();
 create trigger journal_survey_publish_history after insert or update or delete on biohub.survey_publish_history for each row execute procedure tr_journal_trigger();
