...
export async function up(knex: Knex): Promise<void> {
  ...
  -- Create audit and journal triggers
  create trigger survey_audit_sample_method before insert or update or delete on survey_sample_method for each row execute procedure tr_audit_trigger();
  create trigger survey_journal_sample_method after insert or update or delete on survey_sample_method for each row execute procedure tr_journal_trigger();
