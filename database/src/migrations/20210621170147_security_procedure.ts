...
export async function up(knex: Knex): Promise<void> {
  ...
  --- Update the api_set_context function
  ...
  --                  2021-06-22  Added system_user_role_id to the context
  -- *******************************************************************
  declare
  ...
  begin
    ...
    select sr_id into strict v_system_role_id from system_user_role
      where su_id = v_user_id;

    create temp table if not exists ${DB_SCHEMA}_context_temp (tag varchar(200), value varchar(200));
    delete from ${DB_SCHEMA}_context_temp;
    insert into ${DB_SCHEMA}_context_temp (tag, value) values ('user_id', v_user_id::varchar(200));
    insert into ${DB_SCHEMA}_context_temp (tag, value) values ('system_user_role_id', v_system_role_id::varchar(200));
