...
create schema if not exists bio_dapi_v1;

create user biohub_api password 'flatpass';

alter DEFAULT PRIVILEGES in SCHEMA bio_dapi_v1 grant ALL on tables to biohub_api;
\i bio_dapi_views.sql
...
grant usage on schema bio_dapi_v1 to biohub_api;
grant usage on schema biohub to biohub_api;
grant all on all tables in schema bio_dapi_v1 to biohub_api;
alter DEFAULT PRIVILEGES in SCHEMA bio_dapi_v1 grant ALL on tables to biohub_api;

alter role biohub_api set search_path to bio_dapi_v1, biohub;
