...
;
COMMENT ON COLUMN system_user.external_id IS 'The identifier of the user.'
;
...
CREATE UNIQUE INDEX su_nuk1 ON system_user(external_id, uis_id, (record_end_date is NULL)) where record_end_date is null
;
-- 
-- INDEX: "Ref12041" 
--
