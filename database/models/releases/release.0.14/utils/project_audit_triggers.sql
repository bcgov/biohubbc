 ...
 drop trigger if exists audit_proprietor_type on biohub.proprietor_type;
 ...
 drop trigger if exists audit_survey on biohub.survey;
 drop trigger if exists audit_system_role on biohub.system_role;
 drop trigger if exists audit_wldtaxonomic_units on biohub.wldtaxonomic_units;
 ...
 drop trigger if exists audit_survey_proprietor on biohub.survey_proprietor;
 ...
 create trigger audit_wldtaxonomic_units before insert or update or delete on biohub.wldtaxonomic_units for each row execute procedure tr_audit_trigger();
