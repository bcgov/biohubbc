 ...
 drop trigger if exists journal_administrative_activity_type on biohub.administrative_activity_type;
 drop trigger if exists journal_administrative_activity_status_type on biohub.administrative_activity_status_type;
 ...
 drop trigger if exists journal_proprietor_type on biohub.proprietor_type;
 ...
 drop trigger if exists journal_survey on biohub.survey;
 drop trigger if exists journal_system_role on biohub.system_role;
 drop trigger if exists journal_wldtaxonomic_units on biohub.wldtaxonomic_units;
 drop trigger if exists journal_administrative_activity on biohub.administrative_activity;
 ...
 drop trigger if exists journal_survey_proprietor on biohub.survey_proprietor;
 ...
 create trigger journal_wldtaxonomic_units after insert or update or delete on biohub.wldtaxonomic_units for each row execute procedure tr_journal_trigger();
