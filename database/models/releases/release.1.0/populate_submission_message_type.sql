...
insert into submission_message_type (name, record_effective_date, description, submission_message_class_id) values ('Missing Validation Schema', now(), 'Query is unable to fetch validation schema.', (select submission_message_class_id from submission_message_class where name = 'Error'));
