...
-- Project :      BioHub.DM1
--
-- Date Created : Tuesday, October 04, 2022 13:45:30
...
CREATE TABLE survey(
    ...
    geography               character(10),
    geojson                 character(10),
    surveyed_all_areas      character(10),
    create_date             timestamptz(6)    DEFAULT now() NOT NULL,
    create_user             integer           NOT NULL,
    update_date             timestamptz(6),
    update_user             integer,
...
CREATE UNIQUE INDEX field_method_nuk1 ON field_method(name, (record_end_date is NULL)) where record_end_date is null
;
-- 
