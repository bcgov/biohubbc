 ...
 create or replace view field_method as select * from biohub.field_method;
 ...
 create or replace view project_report_author as select * from biohub.project_report_author;
 ...
 create or replace view summary_submission_message_class as select * from biohub.summary_submission_message_class;
 create or replace view summary_submission_message_type as select * from biohub.summary_submission_message_type;
 ...
 create or replace view survey_report_author as select * from biohub.survey_report_author;
 ...
 create or replace view survey_vantage as select * from biohub.survey_vantage;
