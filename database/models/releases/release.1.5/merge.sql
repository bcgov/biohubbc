...
-- Project :      BioHub.DM1
--
-- Date Created : Friday, December 23, 2022 11:14:10
...
CREATE TABLE funding_source(
    ...
    record_effective_date    date              NOT NULL,
    description              varchar(250),
    project_id_optional      timestamptz(6)    NOT NULL,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
    create_user              integer           NOT NULL,
    update_date              timestamptz(6),
    update_user              integer,
...
CREATE TABLE project(
    ...
    coordinator_public           timestamptz(6)              NOT NULL,
...
CREATE TABLE proprietor_type(
    ...
    record_end_date          date,
    description              varchar(250),
    is_first_nation          timestamptz(6)    NOT NULL,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
    create_user              integer           NOT NULL,
    update_date              timestamptz(6),
    update_user              integer,
...
CREATE TABLE study_species(
    ...
    is_focal                 timestamptz(6)    NOT NULL,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
    create_user              integer           NOT NULL,
    update_date              timestamptz(6),
    update_user              integer,
...
CREATE TABLE survey(
    ...
    geography               geography(geometry),
    geojson                 character(10),
    surveyed_all_areas      timestamptz(6),
    create_date             timestamptz(6)              DEFAULT now() NOT NULL,
    create_user             integer                     NOT NULL,
    update_date             timestamptz(6),
    update_user             integer,
...
CREATE TABLE survey_proprietor(
    ...
    disa_required           timestamptz(6)    NOT NULL,
    create_date             timestamptz(6)    DEFAULT now() NOT NULL,
    create_user             integer           NOT NULL,
    update_date             timestamptz(6),
    update_user             integer,
...
CREATE UNIQUE INDEX template_methodology_species_nuk1 ON template_methodology_species(template_id, field_method_id, intended_outcome_id, wldtaxonomic_units_id)
;
-- 
-- INDEX: "Ref190183" 
--
