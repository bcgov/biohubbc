 ...
 create trigger audit_ecological_season before insert or update or delete on biohub.ecological_season for each row execute procedure tr_audit_trigger();
 create trigger audit_field_method before insert or update or delete on biohub.field_method for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_intended_outcome before insert or update or delete on biohub.intended_outcome for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_project_report_attachment before insert or update or delete on biohub.project_report_attachment for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_project_report_author before insert or update or delete on biohub.project_report_author for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_summary_parameter_code before insert or update or delete on biohub.summary_parameter_code for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_summary_submission_message_class before insert or update or delete on biohub.summary_submission_message_class for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_survey_report_author before insert or update or delete on biohub.survey_report_author for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_survey_summary_submission before insert or update or delete on biohub.survey_summary_submission for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_survey_vantage before insert or update or delete on biohub.survey_vantage for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_survey_report_attachment before insert or update or delete on biohub.survey_report_attachment for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_vantage before insert or update or delete on biohub.vantage for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_occurrence_data_package before insert or update or delete on biohub.occurrence_data_package for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_summary_submission_message_type before insert or update or delete on biohub.summary_submission_message_type for each row execute procedure tr_audit_trigger();
