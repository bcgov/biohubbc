 ...
 create trigger journal_ecological_season after insert or update or delete on biohub.ecological_season for each row execute procedure tr_journal_trigger();
 create trigger journal_field_method after insert or update or delete on biohub.field_method for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_intended_outcome after insert or update or delete on biohub.intended_outcome for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_project_report_author after insert or update or delete on biohub.project_report_author for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_summary_submission_message_class after insert or update or delete on biohub.summary_submission_message_class for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_survey_report_author after insert or update or delete on biohub.survey_report_author for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_survey_vantage after insert or update or delete on biohub.survey_vantage for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_survey_report_attachment after insert or update or delete on biohub.survey_report_attachment for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_vantage after insert or update or delete on biohub.vantage for each row execute procedure tr_journal_trigger();
 ...
 create trigger journal_summary_submission_message_type after insert or update or delete on biohub.summary_submission_message_type for each row execute procedure tr_journal_trigger();
