 ...
 alter view activity owner to biohub_api;
 alter view administrative_activity owner to biohub_api;
 alter view administrative_activity_status_type owner to biohub_api;
 alter view administrative_activity_type owner to biohub_api;
 alter view climate_change_initiative owner to biohub_api;
 alter view first_nations owner to biohub_api;
 alter view funding_source owner to biohub_api;
 alter view investment_action_category owner to biohub_api;
 alter view iucn_conservation_action_level_1_classification owner to biohub_api;
 alter view iucn_conservation_action_level_2_subclassification owner to biohub_api;
 alter view iucn_conservation_action_level_3_subclassification owner to biohub_api;
 alter view management_action_type owner to biohub_api;
 alter view permit owner to biohub_api;
 alter view project owner to biohub_api;
 alter view project_activity owner to biohub_api;
 alter view project_attachment owner to biohub_api;
 alter view project_climate_initiative owner to biohub_api;
 alter view project_first_nation owner to biohub_api;
 alter view project_funding_source owner to biohub_api;
 alter view project_iucn_action_classification owner to biohub_api;
 alter view project_management_actions owner to biohub_api;
 alter view project_participation owner to biohub_api;
 alter view project_region owner to biohub_api;
 alter view project_role owner to biohub_api;
 alter view project_type owner to biohub_api;
 alter view proprietor_type owner to biohub_api;
 alter view stakeholder_partnership owner to biohub_api;
 alter view study_species owner to biohub_api;
 alter view survey owner to biohub_api;
 alter view survey_attachment owner to biohub_api;
 alter view survey_funding_source owner to biohub_api;
 alter view survey_occurrence owner to biohub_api;
 alter view survey_proprietor owner to biohub_api;
 alter view survey_publish_history owner to biohub_api;
 alter view system_constant owner to biohub_api;
 alter view system_role owner to biohub_api;
 alter view system_user owner to biohub_api;
 alter view system_user_role owner to biohub_api;
 alter view user_identity_source owner to biohub_api;
 alter view webform_draft owner to biohub_api;
 alter view wldtaxonomic_units owner to biohub_api;
