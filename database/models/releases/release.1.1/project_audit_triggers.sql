 ...
 create trigger audit_common_survey_methodology before insert or update or delete on biohub.common_survey_methodology for each row execute procedure tr_audit_trigger();
