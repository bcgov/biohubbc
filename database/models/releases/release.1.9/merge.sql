...
-- Project :      BioHub.DM1
--
-- Date Created : Friday, April 14, 2023 12:41:17
...
CREATE TABLE field_method(
    field_method_id          integer           GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
    ...
    update_user              integer,
    revision_count           integer           DEFAULT 0 NOT NULL,
    CONSTRAINT field_method_pk PRIMARY KEY (field_method_id)
)
;



COMMENT ON COLUMN field_method.field_method_id IS 'System generated surrogate primary key identifier.'
;
COMMENT ON COLUMN field_method.name IS 'The name of the record.'
;
COMMENT ON COLUMN field_method.record_effective_date IS 'Record level effective date.'
;
COMMENT ON COLUMN field_method.record_end_date IS 'Record level end date.'
;
COMMENT ON COLUMN field_method.description IS 'The description of the record.'
;
COMMENT ON COLUMN field_method.create_date IS 'The datetime the record was created.'
;
COMMENT ON COLUMN field_method.create_user IS 'The id of the user who created the record as identified in the system user table.'
;
COMMENT ON COLUMN field_method.update_date IS 'The datetime the record was updated.'
;
COMMENT ON COLUMN field_method.update_user IS 'The id of the user who updated the record as identified in the system user table.'
;
COMMENT ON COLUMN field_method.revision_count IS 'Revision count used for concurrency control.'
;
COMMENT ON TABLE field_method IS 'A field method is a specific species inventory protocol that may be implemented across various species and strata. Examples include Stratified Random Block.'
;
...
CREATE TABLE occurrence_submission(
    ...
    delete_timestamp                   timestamptz(6),
...
;
COMMENT ON COLUMN occurrence_submission.darwin_core_source IS 'The name of the source system that is supplying the data.'
;
...
-- 
-- TABLE: occurrence_submission_publish 
--
...
;
COMMENT ON COLUMN project.geojson IS 'A JSON representation of the project boundary geometry that provides necessary details for shape manipulation in client side tools.'
;
...
;
COMMENT ON COLUMN project_attachment.uuid IS 'The universally unique identifier for the record.'
;
...
-- 
-- TABLE: project_attachment_publish 
--
...
CREATE TABLE project_funding_source(
    ...
    investment_action_category_id    integer,
    project_id                       integer           NOT NULL,
...
-- 
-- TABLE: project_metadata_publish 
--
...
;
COMMENT ON COLUMN project_report_attachment.uuid IS 'The universally unique identifier for the record.'
;
...
CREATE TABLE proprietor_type(
    ...
    record_end_date          date,
    description              varchar(250),
    is_first_nation          character(10)     NOT NULL,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
    create_user              integer           NOT NULL,
    update_date              timestamptz(6),
    update_user              integer,
...
CREATE TABLE study_species(
    ...
    is_focal                 character(10)     NOT NULL,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
    create_user              integer           NOT NULL,
    update_date              timestamptz(6),
    update_user              integer,
...
;
COMMENT ON COLUMN study_species.wldtaxonomic_units_id IS 'Foreign key to taxonomy service describing the taxonomic unit of the record.'
;
...
-- 
-- TABLE: summary_template_species 
--
...
;
COMMENT ON COLUMN summary_template_species.wldtaxonomic_units_id IS 'Foreign key to taxonomy service describing the taxonomic unit of the record.'
;
...
CREATE TABLE survey(
    ...
    project_id              integer                     NOT NULL,
    field_method_id         integer,
    intended_outcome_id     integer,
    ecological_season_id    integer,
    vantage_id              integer,
    uuid                    uuid                        DEFAULT public.gen_random_uuid(),
    name                    varchar(300),
    additional_details      varchar(3000),
    start_date              date                        NOT NULL,
...
;
COMMENT ON COLUMN survey.field_method_id IS 'System generated surrogate primary key identifier.'
;
...
;
COMMENT ON COLUMN survey.additional_details IS 'The objectives for the survey.'
;
...
;
COMMENT ON COLUMN survey.geojson IS 'A JSON representation of the project boundary geometry that provides necessary details for shape manipulation in client side tools.'
;
...
;
COMMENT ON COLUMN survey_attachment.uuid IS 'The universally unique identifier for the record.'
;
...
-- 
-- TABLE: survey_attachment_publish 
--
...
CREATE TABLE survey_proprietor(
    ...
    disa_required           character(10)     NOT NULL,
    create_date             timestamptz(6)    DEFAULT now() NOT NULL,
    create_user             integer           NOT NULL,
    update_date             timestamptz(6),
    update_user             integer,
...
;
COMMENT ON COLUMN survey_report_attachment.uuid IS 'The universally unique identifier for the record.'
;
...
CREATE TABLE survey_summary_submission(
    ...
    survey_id                       integer           NOT NULL,
    summary_template_species_id     integer,
    uuid                            uuid              DEFAULT public.gen_random_uuid(),
...
;
COMMENT ON COLUMN survey_summary_submission.uuid IS 'The universally unique identifier for the record.'
;
...
-- 
-- TABLE: survey_summary_submission_publish 
--
...
;
COMMENT ON TABLE survey_summary_submission_publish IS 'Provides a history of publish events to BioHub data collection systems.'
;

-- 
-- TABLE: survey_vantage 
--

CREATE TABLE survey_vantage(
    survey_vantage_id    integer           GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
    survey_id            integer           NOT NULL,
...
;
COMMENT ON COLUMN system_user.user_guid IS 'The GUID of the user.'
;
...
CREATE TABLE template_methodology_species(
    ...
    update_user                        integer,
    revision_count                     integer           DEFAULT 0 NOT NULL,
    CONSTRAINT template_methodology_species_pk PRIMARY KEY (template_methodology_species_id)
)
;
...
;
COMMENT ON COLUMN template_methodology_species.field_method_id IS 'System generated surrogate primary key identifier.'
;
COMMENT ON COLUMN template_methodology_species.intended_outcome_id IS 'System generated surrogate primary key identifier.'
;
COMMENT ON COLUMN template_methodology_species.wldtaxonomic_units_id IS 'Foreign key to taxonomy service describing the taxonomic unit of the record.'
;
...
CREATE UNIQUE INDEX activity_nuk1 ON activity(name, record_end_date)
;
-- 
-- INDEX: "Ref78143" 
--
...
CREATE UNIQUE INDEX climate_change_initiative_nuk1 ON climate_change_initiative(name, record_end_date)
;
-- 
-- INDEX: ecological_season_nuk1 
--

CREATE UNIQUE INDEX ecological_season_nuk1 ON ecological_season(name, record_end_date)
;
-- 
-- INDEX: field_method_nuk1 
--

CREATE UNIQUE INDEX field_method_nuk1 ON field_method(name, record_end_date)
;
-- 
...
;
-- 
-- INDEX: intended_outcome_nuk1 
--

CREATE UNIQUE INDEX intended_outcome_nuk1 ON intended_outcome(name, record_end_date)
;
-- 
...
CREATE UNIQUE INDEX management_action_type_nuk1 ON management_action_type(name, record_end_date)
;
-- 
-- INDEX: "Ref153160" 
--
...
;
-- 
-- INDEX: occurrence_submission_publish_uk1 
--

CREATE UNIQUE INDEX occurrence_submission_publish_uk1 ON occurrence_submission_publish(queue_id)
;
-- 
-- INDEX: "Ref165231" 
--

CREATE INDEX "Ref165231" ON occurrence_submission_publish(occurrence_submission_id)
;
-- 
-- INDEX: permit_uk1 
--

CREATE UNIQUE INDEX permit_uk1 ON permit(number, survey_id)
;
-- 
-- INDEX: "Ref153157" 
--
...
;
-- 
-- INDEX: project_attachment_publish_uk1 
--
...
;
-- 
-- INDEX: project_metadata_publish_uk1 
--
...
;
-- 
-- INDEX: project_report_publish_uk1 
--
...
CREATE UNIQUE INDEX proprietor_type_nuk1 ON proprietor_type(name, record_end_date)
;
-- 
...
CREATE UNIQUE INDEX study_species_uk1 ON study_species(survey_id)
;
-- 
-- INDEX: "Ref153158" 
--
...
CREATE UNIQUE INDEX summary_parameter_code_nuk1 ON summary_parameter_code(code, record_end_date)
;
-- 
-- INDEX: summary_submission_message_class_nuk1 
--

CREATE UNIQUE INDEX summary_submission_message_class_nuk1 ON summary_submission_message_class(name, record_end_date)
;
-- 
-- INDEX: summary_submission_message_type_nuk1 
--

CREATE UNIQUE INDEX summary_submission_message_type_nuk1 ON summary_submission_message_type(name, record_end_date)
;
-- 
-- INDEX: "Ref215206" 
--
...
;
-- 
-- INDEX: summary_template_nuk1 
--

CREATE UNIQUE INDEX summary_template_nuk1 ON summary_template(name, version, record_end_date)
;
-- 
-- INDEX: summary_template_species_nuk1 
--

CREATE UNIQUE INDEX summary_template_species_nuk1 ON summary_template_species(summary_template_id)
;
-- 
-- INDEX: "Ref225219" 
--
...
CREATE INDEX "Ref190190" ON survey(field_method_id)
;
-- 
-- INDEX: "Ref223211" 
--
...
;
-- 
-- INDEX: survey_attachment_publish_uk1 
--
...
;
-- 
-- INDEX: survey_metadata_publish_uk1 
--
...
;
-- 
-- INDEX: survey_report_publish_uk1 
--
...
;
-- 
-- INDEX: survey_summary_submission_publish_uk1 
--
...
CREATE INDEX "Ref211232" ON survey_summary_submission_publish(survey_summary_submission_id)
;
-- 
-- INDEX: survey_vantage_uk1 
--

CREATE UNIQUE INDEX survey_vantage_uk1 ON survey_vantage(survey_id, vantage_id)
;
-- 
-- INDEX: "Ref153215" 
--

CREATE INDEX "Ref153215" ON survey_vantage(survey_id)
;
-- 
-- INDEX: "Ref222216" 
--

CREATE INDEX "Ref222216" ON survey_vantage(vantage_id)
;
-- 
...
CREATE UNIQUE INDEX template_nuk1 ON template(name, version, record_end_date)
;
-- 
-- INDEX: template_methodology_species_nuk1 
--

CREATE UNIQUE INDEX template_methodology_species_nuk1 ON template_methodology_species(template_id, field_method_id, intended_outcome_id)
;
-- 
-- INDEX: "Ref190183" 
--

CREATE INDEX "Ref190183" ON template_methodology_species(field_method_id)
;
-- 
-- INDEX: "Ref191187" 
--
...
CREATE UNIQUE INDEX vantage_nuk1 ON vantage(name, record_end_date)
;
-- 
-- INDEX: "Ref78141" 
--
...
ALTER TABLE occurrence_submission_publish ADD CONSTRAINT "Refoccurrence_submission231" 
...
ALTER TABLE submission_spatial_component ADD CONSTRAINT "Refoccurrence_submission224" 
    FOREIGN KEY (occurrence_submission_id)
    REFERENCES occurrence_submission(occurrence_submission_id)
;
...
ALTER TABLE survey ADD CONSTRAINT "Reffield_method190" 
    FOREIGN KEY (field_method_id)
    REFERENCES field_method(field_method_id)
;
...
ALTER TABLE survey_summary_submission_publish ADD CONSTRAINT "Refsurvey_summary_submission232" 
    FOREIGN KEY (survey_summary_submission_id)
    REFERENCES survey_summary_submission(survey_summary_submission_id)
;
...
ALTER TABLE survey_vantage ADD CONSTRAINT "Refsurvey215" 
    FOREIGN KEY (survey_id)
    REFERENCES survey(survey_id)
;

ALTER TABLE survey_vantage ADD CONSTRAINT "Refvantage216" 
    FOREIGN KEY (vantage_id)
    REFERENCES vantage(vantage_id)
;
...
ALTER TABLE template_methodology_species ADD CONSTRAINT "Reffield_method183" 
    FOREIGN KEY (field_method_id)
    REFERENCES field_method(field_method_id)
;
