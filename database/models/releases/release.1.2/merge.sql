...
-- Project :      BioHub.DM1
--
-- Date Created : Tuesday, September 06, 2022 16:28:22
...
CREATE TABLE occurrence(
    ...
    data                        json,
    geometry                    character(10),
    geography                   character(10),
    create_date                 timestamptz(6)    DEFAULT now() NOT NULL,
    create_user                 integer           NOT NULL,
    update_date                 timestamptz(6),
    update_user                 integer,
...
CREATE TABLE security_rule(
    ...
    users                    json,
    system_rule              character(10)     DEFAULT false,
    record_effective_date    date              NOT NULL,
    description              varchar(250),
    record_end_date          date,
    create_date              timestamptz(6)    DEFAULT now() NOT NULL,
...
;
COMMENT ON COLUMN survey_permit.permit_id IS 'System generated surrogate primary key identifier.'
;
COMMENT ON COLUMN survey_permit.survey_id IS 'System generated surrogate primary key identifier.'
;
COMMENT ON COLUMN survey_permit.create_date IS 'The datetime the record was created.'
;
COMMENT ON COLUMN survey_permit.create_user IS 'The id of the user who created the record as identified in the system user table.'
;
COMMENT ON COLUMN survey_permit.update_date IS 'The datetime the record was updated.'
;
COMMENT ON COLUMN survey_permit.update_user IS 'The id of the user who updated the record as identified in the system user table.'
;
COMMENT ON COLUMN survey_permit.revision_count IS 'Revision count used for concurrency control.'
;
COMMENT ON TABLE survey_permit IS 'An associative entity that joins surveys and permits.'
;
...
CREATE TABLE survey_summary_detail(
    ...
    total_area_surveyed_sqm         numeric(14, 2),
...
;
COMMENT ON COLUMN survey_summary_detail.analysis_method IS 'The analysis method of the data in the record.'
;
...
CREATE UNIQUE INDEX survey_permit_uk1 ON survey_permit(permit_id, survey_id)
;
-- 
-- INDEX: "Ref133218" 
--

CREATE INDEX "Ref133218" ON survey_permit(permit_id)
;
-- 
-- INDEX: "Ref153219" 
--

CREATE INDEX "Ref153219" ON survey_permit(survey_id)
;
-- 
-- INDEX: "Ref159153" 
--
...
CREATE UNIQUE INDEX template_methodology_species_uk1 ON template_methodology_species(template_id, field_method_id, intended_outcome_id)
;
-- 
-- INDEX: "Ref190183" 
--
...
ALTER TABLE survey_permit ADD CONSTRAINT "Refpermit218" 
    FOREIGN KEY (permit_id)
    REFERENCES permit(permit_id)
;

ALTER TABLE survey_permit ADD CONSTRAINT "Refsurvey219" 
    FOREIGN KEY (survey_id)
    REFERENCES survey(survey_id)
;
