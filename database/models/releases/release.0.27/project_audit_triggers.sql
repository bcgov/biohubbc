 ...
 create trigger audit_summary_parameter_method_code before insert or update or delete on biohub.summary_parameter_method_code for each row execute procedure tr_audit_trigger();
 ...
 create trigger audit_author before insert or update or delete on biohub.author for each row execute procedure tr_audit_trigger();
