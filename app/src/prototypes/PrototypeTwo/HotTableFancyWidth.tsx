...
export interface IHotTableProps {
  hotTableParentRef: any;
}

const HotTableFancyWidth: React.FC<IHotTableProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const paddingBorderOffset = 105;

    setColWidthsPixels(
      getColumnWidthsPixels(colWidthsPercent, props.hotTableParentRef.current.offsetWidth - paddingBorderOffset)
    );
...
export default HotTableFancyWidth;
