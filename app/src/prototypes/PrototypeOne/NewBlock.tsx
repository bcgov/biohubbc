...
import CreateSurveySection from 'features/surveys/CreateSurveySection';
        ...
        <Container maxWidth="xl">
          <Box mb={3}>
            <Breadcrumbs>
              ...
              <Typography variant="body2">New Block Survey</Typography>
            </Breadcrumbs>
          </Box>
              ...
              {({ values, touched, errors, handleChange }) => (
                <>
                  <CreateSurveySection
                    ...
                    summary="Enter the block information where you are recording your observations"
                    component={
                      <form>
                  ...
                  <CreateSurveySection
                    title="Participants"
                    summary="Participants recording observations during this survey"
                    component={
                      <form>
                        <Grid container spacing={3}>
                          <Grid item xs={12} md={6}>
                  ...
                  <CreateSurveySection
                    ...
                    summary="Weather and habitat description of block"
                    component={
                      <form>
                        <Grid container spacing={3}>
                          <Grid item xs={12} md={4}>
                  ...
                  <CreateSurveySection
                    ...
                    summary="Details regarding the aircraft used during this survey"
                    component={
                      <form>
                        <Grid container spacing={3}>
                          <Grid item xs={12} md={4}>
