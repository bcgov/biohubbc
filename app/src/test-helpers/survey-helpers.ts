...
export const surveyObject: SurveyViewObject = {
  ...
  species: {
    focal_species: [{ tsn: 1, commonNames: ['focal species 1'], scientificName: 'scientific name 1', rank: 'species', kingdom: 'animalia' }],
    ancillary_species: [{ tsn: 2, commonNames: ['focal species 2'], scientificName: 'scientific name 2', rank: 'species', kingdom: 'animalia' }]
  },
  site_selection: {
    strategies: [],
    stratums: []
