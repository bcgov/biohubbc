import { Box, IconButton, LinearProgress, ListItem, makeStyles, Theme, Typography } from '@material-ui/core';
...
const FileUploadItem: React.FC<IFileUploadItemProps> = (props) => {
  ...
  }, [file, biohubApi, status, cancelToken, props.projectId, isMounted, initiateCancel, error, handleFileUploadError]);
