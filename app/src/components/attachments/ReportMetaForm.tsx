...
export const ReportMetaFormYupSchema = yup.object().shape({
  ...
  year_published: yup.number().min(1900, 'Must be between 1900 and 2199').max(2199, 'Must be between 1900 and 2199'),
  attachmentId: yup.number().min(1, 'Must have a file uploaded').required('RequAired'),
