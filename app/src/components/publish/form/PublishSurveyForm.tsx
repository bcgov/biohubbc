...
import { PublishSurveyTagsContainer } from './tags/PublishSurveyTagsContainer';

interface IPublishSurveyFormProps {
  tags: IAutocompleteFieldOption<string>[];
}
 ...
 * @return {*}
 */
export const PublishSurveyForm = (props: IPublishSurveyFormProps) => {
  const { tags } = props;
  ...
  return (
    <Stack spacing={8}>
      <Box>
        ...
        <PublishSurveyTagsContainer options={tags} />
      </Box>
      ...
      <Box component="fieldset">
        ...
        <FormGroup>
          ...
          <FormControlLabel
            ...
            label={
              <Typography variant="body1">
                All data and information for this survey has been collected legally, and in accordance with Section 1 of
                the{' '}
                <a
                  href="https://www2.gov.bc.ca/gov/content/environment/natural-resource-stewardship/laws-policies-standards-guidance/data-information-security"
                  target="_blank"
