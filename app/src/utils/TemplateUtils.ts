 ...
 *   'x-enum-code': {
 *     'x-enum-code-table': 'name_of_the_database_table',
 *     'x-enum-code-id-column': 'name_of_the_column_holding_the_unique_id',
 *     'x-enum-code-text-column': 'name_of_the_column_holding_the_human_readable_name'
 *   }
 * }
 *
 * @export
