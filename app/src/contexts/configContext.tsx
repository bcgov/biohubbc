 ...
 *
 * Note: All changes env vars here must also be reflected in the `app/server/index.js` file, so that the app has access
 * to the same env vars when running in both local development (via docker-compose) and in OpenShift.
 *
 * @return {*}  {IConfig}
 */
