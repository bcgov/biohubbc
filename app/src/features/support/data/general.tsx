...
const general = [
  {
    ...
    description: [
      <Typography variant="body1" gutterBottom key="gensims1">
      ...
      <Typography variant="body1" gutterBottom key="gensims3">
        <strong>Appropriate Use of SIMS</strong>
      </Typography>,
      <Typography variant="body1" gutterBottom key="gensims4">
      ...
      <Typography variant="body1" gutterBottom key="gensims5">
      ...
      <Typography variant="body1" gutterBottom key="gensims6">
        <strong>Data Structure in SIMS</strong>
      </Typography>,
      <Typography variant="body1" gutterBottom key="gensims7">
      ...
      <Typography variant="body1" gutterBottom key="gensims8">
      ...
      <Typography variant="body1" gutterBottom key="gensims9">
        <strong>SIMS Roles</strong>
      </Typography>,
      <Typography variant="body1" gutterBottom key="gensims10">
      ...
      <Typography variant="body1" gutterBottom key="gensims11">
  ...
  },
  {
    label: 'FAQ',
    description: [
      <Typography variant="body1" gutterBottom key="genfaq1">
        <strong>FAQ</strong>
      </Typography>,
      <Typography variant="body1" gutterBottom key="genfaq2">
        <strong>Will my data end up in the BC Geographic Warehouse (BCGW)?</strong>
      </Typography>,
      <Typography variant="body1" gutterBottom key="genfaq3">
