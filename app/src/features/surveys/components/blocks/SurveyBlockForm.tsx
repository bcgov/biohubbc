      ...
      {editData && (
        <YesNoDialog
          ...
          dialogText={`Are you sure you want to delete this Block? This will remove the Block from ${
            editData?.block.sample_block_count
          } sampling ${p(editData.block.sample_block_count, 'site')} that currently ${
            editData.block.sample_block_count > 1 ? 'reference' : 'references'
          } it.`}
