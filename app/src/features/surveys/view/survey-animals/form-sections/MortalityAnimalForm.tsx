...
import { ANIMAL_FORM_MODE, AnimalFormProps, AnimalMortalitySchema, ICreateCritterMortality, isRequiredInSchema } from '../animal';
...
const MortalityAnimalForm = (props: AnimalFormProps<ICreateCritterMortality>) => {
  ...
  return (
    <EditDialog
      ...
      component={{
        initialValues: {
          // TODO fill in the remaining initial values
          mortality_timestamp: props.formObject?.mortality_timestamp,
        },
        validationSchema: AnimalMortalitySchema,
        element: (
          <Stack gap={4}>
            ...
            <LocationEntryForm
              locations={props.formObject?.location ? [props.formObject.location] : []}
              // name={name}
              // index={index}
              // value={value}
            ...
            <Box component="fieldset">
              ...
              <Grid container spacing={1}>
                ...
                <Grid item xs={12} sm={4}>
                  <CbSelectField
                    name={'ultimate_predated_by_itis_tsn'}
                    label={'Taxon'}
                    controlProps={{
