...
export interface IDeviceFormHeaderProps {
  project_id: number;
  project_name: string;
  survey_id: number;
  survey_name: string;
...
/**
 * Renders the header of the create and edit device pages.
 *
 * @param {IDeviceFormHeaderProps} props
 * @return {*}
 */
export const DeviceFormHeader = (props: IDeviceFormHeaderProps) => {
  const history = useHistory();
  const formikProps = useFormikContext<CreateTelemetryDevice>();
