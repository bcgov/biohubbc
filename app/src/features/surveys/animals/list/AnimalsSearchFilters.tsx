...
interface IAnimalsSearchFiltersProps {
  onChange: (filterValues: IAnimalsAdvancedFilters) => void;
}

const AnimalsSearchFilters = (props: IAnimalsSearchFiltersProps) => {
  const [showAdvancedFilters, setShowAdvancedFilters] = useState(false);
  // const biohubApi = useBiohubApi();

  const codesContext = useCodesContext();

  const { values, setFieldValue } = useFormikContext<IAnimalsAdvancedFilters>();
...
export default AnimalsSearchFilters;
