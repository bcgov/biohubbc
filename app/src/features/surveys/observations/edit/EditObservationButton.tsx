...
import EditObservationDialog from './dialog/EditObservationDialog';

export const EditObservationButton = () => {
  ...
  return (
    <>
      ...
      <EditObservationDialog open={open} onClose={() => setOpen(false)} onSave={handleSubmitObservation} />
    </>
  );
};
