...
interface IObservationsSearchFiltersProps {
  onChange: (filterValues: IObservationsAdvancedFilters) => void;
}

const ObservationsSearchFilters = (props: IObservationsSearchFiltersProps) => {
  const [showAdvancedFilters, setShowAdvancedFilters] = useState(false);
  // const biohubApi = useBiohubApi();

  const codesContext = useCodesContext();

  const { values, setFieldValue } = useFormikContext<IObservationsAdvancedFilters>();
...
export default ObservationsSearchFilters;
