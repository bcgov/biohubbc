...
import ProjectSurveyListPage from 'features/projects/view/ProjectSurveyListPage';
      ...
      <Container maxWidth="xl">
        <Box display="flex" flexDirection="row" py={6}>
          ...
          <Box component="article" flex="1 1 auto">
            ...
            {location.pathname.includes('/surveys') && <ProjectSurveyListPage projectForViewData={projectWithDetails} codes={codes} refresh={getProject}/>}
