          ...
          <ListItem disableGutters divider key={item.id}>
            <Box flex="1 1 auto">
              ...
              <Box component="dl" mt={1} mb={0} className={classes.fundingSourceMeta}>
                <Box display="flex">
                  <Typography component="dt" color="textSecondary">Project ID</Typography>
                  <Typography component="dd">
                    {item.agency_project_id || 'No Agency Project ID'}
                  </Typography>
                </Box>
                <Box display="flex">
                  <Typography component="dt" color="textSecondary">Amount</Typography>
                  <Typography component="dd">
                    {getFormattedAmount(item.funding_amount)}
                  </Typography>
                </Box>
                <Box display="flex">
                  <Typography component="dt" color="textSecondary">Timeline</Typography>
                  <Typography component="dd">
